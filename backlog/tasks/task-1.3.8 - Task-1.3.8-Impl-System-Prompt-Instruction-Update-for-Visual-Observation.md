...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 The System Prompt ("Alex" Persona) must be updated to instruct the AI to observe and comment on the screen share feed.
- [ ] #2 The AI must recognize predefined screen events (e.g., terminal output, code being typed) and trigger follow-up questions.
- [ ] #3 The bot's personality and instructions remain aligned with a "Helpful but Rigorous Senior Architect".
<!-- AC:END -->
