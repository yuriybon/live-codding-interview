...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 A connected client that sends a valid join_session message is accepted and no longer receives Not authenticated errors during normal flow.
<!-- AC:END -->
